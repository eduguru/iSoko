...
final class FeaturedDealItemCell: UICollectionViewCell {
    ...
    private var currentItem: FeaturedDealItem?
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            imageView.heightAnchor.constraint(equalTo: imageView.widthAnchor, multiplier: 1.0), // Proportional height
            ...
            textStack.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -12) // Fixed bottom constraint
        ])
    }
    
    func configure(with item: FeaturedDealItem) {
        ...
        // Formats raw ALL CAPS strings nicely into Capitalized Case
