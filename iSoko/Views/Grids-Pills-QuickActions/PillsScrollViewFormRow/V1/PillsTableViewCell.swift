...
extension PillsTableViewCell: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        cell.respectsFixedWidth = (layoutMode == .segmentedStretch)  // ADD
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        case .segmentedStretch:
            // Use frame width as fallback before bounds are available
            ...
            let width = max(0, (availableWidth - totalSpacing) / CGFloat(items.count))
            return CGSize(width: width, height: 40)
        }
    }
    ...
    override func layoutSubviews() {
        ...
        // Re-invalidate when bounds change so segmentedStretch recalculates correctly
        if layoutMode == .segmentedStretch {
