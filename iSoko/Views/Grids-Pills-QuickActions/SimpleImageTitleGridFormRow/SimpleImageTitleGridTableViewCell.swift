//
//  SimpleImageTitleGridTableViewCell.swift
//  
//
...
final class SimpleImageTitleGridTableViewCell: UITableViewCell {

    private var items: [SimpleImageTitleGridModel] = []
    ...
    private func setupCollectionView() {
        ...
        collectionView.register(UINib(nibName: "SimpleImageTitleGridCollectionViewCell", bundle: nil),
                                forCellWithReuseIdentifier: "SimpleImageTitleGridCollectionViewCell")
    ...
    func configure(with items: [SimpleImageTitleGridModel], columns: Int) {
        self.items = items
...
extension SimpleImageTitleGridTableViewCell: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(
            withReuseIdentifier: "SimpleImageTitleGridCollectionViewCell", for: indexPath
        ) as? SimpleImageTitleGridCollectionViewCell else {
            assertionFailure("❌ Could not dequeue SimpleImageTitleGridCollectionViewCell")
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        print("📐 SimpleImageTitleGridTableViewCell - width: \(width), columns: \(numberOfColumns), itemWidth: \(itemWidth)")
