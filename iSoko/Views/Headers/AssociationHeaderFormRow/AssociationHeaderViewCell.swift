//
//  AssociationHeaderViewCell.swift
//  
//
...
class AssociationHeaderViewCell: UITableViewCell {
    ...
    private var model: AssociationHeaderModel?
    ...
    public func configure(with model: AssociationHeaderModel) {
        self.model = model
...
//
        ...
        labelDescription.text = model.desc ?? "nada"
        
        labelTitle.numberOfLines = 0
        labelSubTitle.numberOfLines = 0
        labelDescription.numberOfLines = 0
        
        applyStyling(to: labelTitle, style: FontStyle.headline)
        applyStyling(to: labelSubTitle, style: FontStyle.subheadline)
        applyStyling(to: labelDescription, style: FontStyle.body)
    }
