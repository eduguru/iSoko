...
final class ServiceCategoriesViewModel: FormViewModel {

    // MARK: - Callbacks
    var onTapProduct: ((TradeServiceCategoryResponse) -> Void)?
    var onToggleFavorite: ((Bool, TradeServiceCategoryResponse) -> Void)?
