//
//  BookKeepingExpensesViewController.swift
//
//
...
class BookKeepingExpensesViewController: FormViewController, CloseableViewController {
    ...
    override func viewDidLoad() {
        ...
        title = "common.label.expenses".localized
