//
//  BookKeepingSuppliesDetailsViewController.swift
//  
//
...
class BookKeepingSuppliesDetailsViewController: FormViewController, CloseableViewController {
    ...
    @objc private func didTapEdit() {
        guard let model = viewModel as? BookKeepingSuppliesDetailsViewModel else { return }
