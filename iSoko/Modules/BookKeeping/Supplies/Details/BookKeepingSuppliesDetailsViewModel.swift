//
//  BookKeepingSuppliesDetailsViewModel.swift
//  
//
...
@MainActor
final class BookKeepingSuppliesDetailsViewModel: FormViewModel {
    var goToDetails: (() -> Void)? = { }
    
    var goToEdit: ((SupplierResponse) -> Void)? = { _ in }
